...
#### `if(typeof methodOrMessage.time)`

**Parameters:**

- `typeof methodOrMessage.time` (`any`) - 
...
- `const [name` (`any`) - 
- `desc] of Object.entries(Object.getOwnPropertyDescriptors(obj))` (`any`) - 
...
- `!shouldRegisterQFuncMethod(what)` (`any`) - 
...
- `typeof methodName !` (`any`) - 

#### `if(methodName.indexOf('.') < 0 && typeof model[methodName] !)`

**Parameters:**

- `methodName.indexOf('.') < 0 && typeof model[methodName] !` (`any`) - 
...
#### `if(this.subscriptions[topic].indexOf(handler) !)`

**Parameters:**

- `this.subscriptions[topic].indexOf(handler) !` (`any`) - 
...
- `handlers[i].startsWith(handlerPrefix)` (`any`) - 

#### `if(typeof nameString !)`

**Parameters:**

- `typeof nameString !` (`any`) - 
...
- `this.genericSubscriptions.length > 0` (`any`) - 

#### `if(this.subscriptions[topic])`

**Parameters:**

- `this.subscriptions[topic]` (`any`) - 
...
- `const subscription of this.genericSubscriptions` (`any`) - 
...
#### `if(typeof model[methodName] !)`

**Parameters:**

- `typeof model[methodName] !` (`any`) - 
...
#### `if(sinceLast < SNAPSHOT_MIN_POLL_GAP)`

**Parameters:**

- `sinceLast < SNAPSHOT_MIN_POLL_GAP` (`any`) - 
...
- `this.inPersistenceCoolOff` (`any`) - 

#### `if(timeUntilReady > 0)`

**Parameters:**

- `timeUntilReady > 0` (`any`) - 
