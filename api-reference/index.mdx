...
Model time however only advances synchronously on every iteration of the [main loop](#sessionjoin).
...
The time received is related to the local real-world time. If you need to access the model's time, use [this.now()](#viewnow).
